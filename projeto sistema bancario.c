...
void cadastrarUsuario()
{
    ...
    if (contador < 2 )
    {
        ...
        for (f = 0; f < tamanhoArrayExtrato; f++)
        {
            ...
            pessoas[contador].conta.ultimosDepositos[f].estaIniciado = 0;
            pessoas[contador].conta.ultimosSaques[f].estaIniciado = 0;
            pessoas[contador].conta.ultimasTransferencias[f].estaIniciado = 0;
        }
